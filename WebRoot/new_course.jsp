...
<head>
	...
	<script src="js/Course/new_course.js" type="text/javascript"></script>
...
<div class="subject">
    ...
    <label>
    	<em>学科分类：</em>
    	<select id = "subSelect" class = "SelectL" >
    	</select>
    </label>
    <label>
    	<em>课程概述：</em>
    ...
    <div class="pic_button">
    	...
    	<input class="submitBTN" onclick="confirmSaveCourse()" type="submit" value="" />
    </div>
</div>
</body>
</html>
