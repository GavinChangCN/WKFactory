...
public class showChooseChapterServlet extends HttpServlet {
	 ...
	 */
	public showChooseChapterServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ChapterEntity cha = new ChapterEntity() ;
		cha.setCourseNum(courseNum) ;
		cha.setListId( listId ) ;
		JSONObject json = bllInterface.showChooseChapter( cha ) ;
