...
public class QueryCourseByUserNumServlet extends HttpServlet {
	 ...
	 */
	public QueryCourseByUserNumServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("查询自己创建的课程的用户Num："+userNum);
		JSONArray jsonArray = bllInterface.QueryCourseByUserNum( userNum ) ;
