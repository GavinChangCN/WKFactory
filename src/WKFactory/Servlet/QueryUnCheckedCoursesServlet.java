...
public class QueryUnCheckedCoursesServlet extends HttpServlet {
	 ...
	 */
	public QueryUnCheckedCoursesServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Short check = Short.parseShort( request.getParameter( "isCheck" ) ) ;
		System.out.println("获得的ischeck:"+check);
		JSONArray jsonArray = bllInterface.QueryUncheckedCourses( check ) ;
		out.print( jsonArray ) ;
		out.flush();
		out.close();
	}
