...
public class QueryUnsureCourseServlet extends HttpServlet {
	 ...
	 */
	public QueryUnsureCourseServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String inputName = request.getParameter( "CourseName" ) ;
		JSONArray jsonArray = new JSONArray() ;
		jsonArray = bllInterface.QueryUnsureCourse( inputName ) ;
