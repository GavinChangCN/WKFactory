...
public class QueryChapterByCourseNumServlet extends HttpServlet {
	 ...
	 */
	public QueryChapterByCourseNumServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		JSONArray jsonArray = bllInterface.QueryChapterByCourseNum( courseNum ) ;
