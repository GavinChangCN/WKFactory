...
public class QueryUnCheckedChaptersServlet extends HttpServlet {
	 ...
	 */
	public QueryUnCheckedChaptersServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		JSONArray jsonArray = bllInterface.QueryUncheckedChapters( check ) ;
		out.print( jsonArray ) ;
		out.flush();
		out.close();
	}
