...
public class DeleteAccessoryServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int accessoryId = Integer.parseInt( new String( request.getParameter("AccessoryId") ) ) ;
		boolean check = bllInterface.DeleteAccessory( accessoryId ) ;
		...
		System.out.println( "Result的结果（0：删除成功，1：删除失败）："+json ) ;
		out.print( json );
		out.close() ;
	}
