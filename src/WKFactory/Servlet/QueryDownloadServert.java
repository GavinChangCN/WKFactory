...
public class QueryDownloadServert extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		acc.setObjectNum(objectNum) ;
		acc.setObjectType(objectType) ;
